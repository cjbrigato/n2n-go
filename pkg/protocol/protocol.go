...
const (
	FlagExtendedAddressing = 0x01 // Indicates full IDs are in payload
	FlagReserved1          = 0x02
	FlagReserved2          = 0x04
	FlagReserved3          = 0x08
	FlagUserDefined1       = 0x10
	FlagUserDefined2       = 0x20
	FlagUserDefined3       = 0x40
	FlagUserDefined4       = 0x80
)
...
type CompactHeader struct {
	...
	Flags      uint8      // Flags for various options
...
func (h *CompactHeader) SetExtendedAddressing(value bool) {
	if value {
		...
		h.Flags &= ^uint8(FlagExtendedAddressing)
	}
}
